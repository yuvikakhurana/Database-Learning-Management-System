...
public class LMSServer implements Runnable  {
    ...
    //METHOD TO WRITE TO THE FILE TO ENSURE DATA PERSISTANCE EVEN AFTER SERVER IS CLOSED
    ...
    public void run() {
        ...
        try {
                                    ...
                                    if (studentSelection2 == 1) {
                                        ...
                                        if (studentSelection3 == 1) {
                                            ...
                                            synchronized (postGateKeeper) {
                                                for (int i = 0; i < postArrayList.size(); i++) {
                                                    if (postArrayList.get(i).getCourseName().equalsIgnoreCase(courseName)
                                                            && postArrayList.get(i).getDiscussionTopic().getTopic().equals(
                                                            topic2)
                                                            && postArrayList.get(i).getPost() == null) {
                                            ...
                                            // Retrieving the discussion topic object to create a new Post Object if needed
                                            for (int i = 0; i < postArrayList.size(); i++) {
                                                if (postArrayList.get(i).getCourseName().equalsIgnoreCase(courseName)
                                                        && postArrayList.get(i).getDiscussionTopic() != null
                                                        && postArrayList.get(i).getDiscussionTopic().getTopic().equals(topic2)) {
            ...
            System.out.println("There was an error in the writing/reading objects from the client or the client closed the program abruptly");
