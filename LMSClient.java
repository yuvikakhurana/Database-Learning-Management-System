                    ...
                    if (teacherUserSelection1 == 1) {
                        ...
                        if (coursesStatus.equals("no courses")) {
                            ...
                            if (noDiscussionForums) {
                                ...
                                ArrayList<DiscussionTopic> ensureNoRepetition = new ArrayList<>();

                                for (int i = 0; i < posts.size(); i++) {

                                    if (posts.get(i).getCourseName().equalsIgnoreCase(courseName1)) {
                                        if (!ensureNoRepetition.contains(posts.get(i).getDiscussionTopic())) {
                                            ...
                                            System.out.println();
                                            ensureNoRepetition.add(posts.get(i).getDiscussionTopic());
                                            discussionNumber++;
                                        }
                                    }
                                }
