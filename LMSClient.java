 ...
 *
 * This class represents the Client side of the project, user uses GUI to interact with the system.
 * The client will send user inputs to the server and receives data from the server.
...
public class LMSClient {
    ...
    public static void main(String[] args) {
            ...
            do {
                ...
                try {
                    portNumber = Integer.parseInt(JOptionPane.showInputDialog(null,
                            "Enter Port number", "Learning Management System",
        ...
        while (userSelection == -1) {
            ...
            userSelection = JOptionPane.showOptionDialog(null,
                    "Please choose one of the following:", "Learning Management System",
                ...
                if (userSelection == 1) {
                    ...
                    while (name == null || name.equals("")) {
                        JOptionPane.showMessageDialog(null,
                                ...
                                "LMS SignUp", JOptionPane.ERROR_MESSAGE);
                    ...
                    while (username == null || username.equals("")) {
                        JOptionPane.showMessageDialog(null,
                                "Invalid input! Please enter a username!",
                                "LMS SignUp", JOptionPane.ERROR_MESSAGE);
                    ...
                    do {
                        ...
                        if (usernameVerify) {
                            JOptionPane.showMessageDialog(null,
                                    "Invalid. Username has already been taken. Please enter another username.",
                                    "LMS SignUp", JOptionPane.ERROR_MESSAGE);
                            ...
                            while (username == null || username.equals("")) {
                                JOptionPane.showMessageDialog(null,
                                        "Invalid input! Please enter a username!", "LMS SignUp",
                    ...
                    while (password == null || password.equals("")) {
                        JOptionPane.showMessageDialog(null,
                                "Invalid input! Please enter a password!", "LMS SignUp",
                                JOptionPane.ERROR_MESSAGE);
                    ...
                    int userRoleSelection = JOptionPane.showOptionDialog(null,
                            "Please choose your role:", "Learning Management System",
                            JOptionPane.PLAIN_MESSAGE, 1, null, options1, options1[0]);
                    while (userRoleSelection == -1) {
                        invalidInputMessage();
                        userRoleSelection = JOptionPane.showOptionDialog(null,
                                "Please choose your role:", "Learning Management System",
                                JOptionPane.PLAIN_MESSAGE, 1, null, options1, options1[0]);
                    }
                    ...
                    do {
                        ...
                        while (username == null || username.equals("")) {
                            JOptionPane.showMessageDialog(null,
                                    "Invalid input! Please enter a username!", "LMS Login",
                                    JOptionPane.ERROR_MESSAGE);
                            username = JOptionPane.showInputDialog(null,
                                    "Please enter a username",
                                    "LMS Login", JOptionPane.QUESTION_MESSAGE);
                        ...
                        while (password == null || password.equals("")) {
                            JOptionPane.showMessageDialog(null,
                                    "Invalid input! Please enter a password!", "LMS Login",
                                    JOptionPane.ERROR_MESSAGE);
                        ...
                        if (verifySignIn.equals("no accounts found")) {
                            ...
                            JOptionPane.showMessageDialog(null,
                                    "No Account found with the given username. Please create an account",
                                    "Learning Management System", JOptionPane.ERROR_MESSAGE);
                            break;
                        }
                ...
                if (lmsClient != null && lmsClient.getPerson1() instanceof Teacher) {
                    ...
                    do {
                        ...
                        if (teacherUserSelection1 == 1) {
                            ...
                            int editOrDelete = JOptionPane.showOptionDialog(null,
                                    "Please choose one of the following",
                                    "Learning Management System", JOptionPane.PLAIN_MESSAGE,
                                    1, null,
                            ...
                            while (editOrDelete == 0) {
                                invalidInputMessage();
                                editOrDelete = JOptionPane.showOptionDialog(null,
                                        "Please choose one of the following",
                                        "Learning Management System", JOptionPane.PLAIN_MESSAGE,
                                        1, null,
                                        options8, options8[0]) + 1;
                            ...
                            if (editOrDelete == 1) {
                                ...
                                int modifyAccount = JOptionPane.showOptionDialog(null,
                                ...
                                while (modifyAccount == 0) {
                                    invalidInputMessage();
                                    modifyAccount = JOptionPane.showOptionDialog(null,
                                            "Please select the part you want to modify: ",
                                            "Learning Management System", JOptionPane.PLAIN_MESSAGE,
                                            1, null,
                                            options9, options9[0]) + 1;
                                ...
                                if (modifyAccount == 1) {
                                    ...
                                    do {
                                        ...
                                        while (newUserName == null || newUserName.equals("")) {
                                            ...
                                            JOptionPane.showMessageDialog(null,
                                                    "Invalid input! Please enter a username!",
                                                    "Learning Management System", JOptionPane.ERROR_MESSAGE);
                                            newUserName = JOptionPane.showInputDialog(null,
                                                    "Please enter the new username:",
                                                    "Learning Management System", JOptionPane.QUESTION_MESSAGE);
                                        }
                                        ...
                                        if (usernameVerify) {
                                            ...
                                            JOptionPane.showMessageDialog(null,
                                                    "Invalid. Username has already been taken. " +
                                                            "Please enter another username.",
                                                    "Learning Management System", JOptionPane.ERROR_MESSAGE);
                                        }
                                    ...
                                    while (newPassword == null || newPassword.equals("")) {
                                        ...
                                        JOptionPane.showMessageDialog(null,
                                                "Invalid input! Please enter a password!",
                                                "Learning Management System", JOptionPane.ERROR_MESSAGE);
                    ...
                    String[] studentMenu1 = {"Select a course", "View my Grades", "Edit or delete account", "Exit"};
                    int studentSelection1 = JOptionPane.showOptionDialog(null,
                            "Please choose one of the following:", "Learning Management System",
                            JOptionPane.PLAIN_MESSAGE, 1, null, studentMenu1, null) + 1;

                    while (studentSelection1 == 0) {
                        invalidInputMessage();
                        studentSelection1 = JOptionPane.showOptionDialog(null,
                                "Please choose one of the following:", "Learning Management System",
                                JOptionPane.PLAIN_MESSAGE, 1, null, studentMenu1, null) + 1;
                    }
                        ...
                        if (studentSelection1 == 1) {
                            ...
                            if (counter == 0) {
                                ...
                                JOptionPane.showMessageDialog(null, sb.toString(),
                                        "Learning Management System: Grades",
                            ...
                            int editOrDelete = JOptionPane.showOptionDialog(null,
                                    "Please choose one of the following", "Learning Management System",
                                    JOptionPane.PLAIN_MESSAGE, 1, null,
                                    options8, options8[0]) + 1;
    ...
    public static void studentSelection1GUI() throws Exception {
        ...
        if (coursesStatus.equals("no courses")) {
            ...
            String courseName1 = (String) JOptionPane.showInputDialog(null,
                    "Select Course", "Learning Management System",
                    JOptionPane.PLAIN_MESSAGE, null, courseArray, null);

            while (courseName1 == null) {
                invalidInputMessage();
                courseName1 = (String) JOptionPane.showInputDialog(null,
                        "Select Course", "Learning Management System",
                        JOptionPane.PLAIN_MESSAGE, null, courseArray, null);
            }
            ...
            if (noDiscussionForums) {
                ...
                int studentSelection2 = JOptionPane.showOptionDialog(null,
                        courseName1 + ":", "Learning Management System",
                        JOptionPane.PLAIN_MESSAGE, 1, null, options13, null) + 1;

                while (studentSelection2 == 0) {
                    invalidInputMessage();
                    studentSelection2 = JOptionPane.showOptionDialog(null,
                            courseName1 + ":", "Learning Management System",
                            JOptionPane.PLAIN_MESSAGE, 1, null, options13, null) + 1;
                }
                ...
                if (studentSelection2 == 1) {
                    ...
                    if (noDisc) {
                        ...
                        String discussionSelected = (String) JOptionPane.showInputDialog(null,
                                stringBuilder.toString(), "Learning Management System",
                                JOptionPane.PLAIN_MESSAGE, null, discussionMenu.toArray(), null);

                        while (discussionSelected == null) {
                            invalidInputMessage();
                            discussionSelected = (String) JOptionPane.showInputDialog(null,
                                    stringBuilder.toString(), "Learning Management System",
                                    JOptionPane.PLAIN_MESSAGE, null,
                                    discussionMenu.toArray(), null);
                        }
                        ...
                        for (int i = 0; i < posts.size(); i++) {
                            if (posts.get(i).getCourseName().equalsIgnoreCase(courseName1) &&
                                ...
                                stringBuilder1.append(stringInLinesMethod(posts.get(i).getDiscussionTopic(
                                ).getTopic()));
                                stringBuilder1.append("\n");
                        ...
                        if (noResponses) {
                            JOptionPane.showMessageDialog(null, stringBuilder1.toString(),
                                    "Learning Management System", JOptionPane.PLAIN_MESSAGE);
                        } else {
                            String responseStringSelected = (String) JOptionPane.showInputDialog(null,
                                    stringBuilder1.toString(), "Learning Management System",
                                    JOptionPane.PLAIN_MESSAGE, null,
                                    responseMenu.toArray(), null);

                            while (responseStringSelected == null) {
                                invalidInputMessage();
                                responseStringSelected = (String) JOptionPane.showInputDialog(null,
                                        stringBuilder1.toString(), "Learning Management System",
                                        JOptionPane.PLAIN_MESSAGE, null,
                                        responseMenu.toArray(), null);
                            }
                            ...
                            if (responses != null) {
                                for (int i = 0; i < responses.size(); i++) {
                                    if (responses.get(i).contains("Response #" + replyNumber + " ")) {
                                        response = responses.get(i).substring(responses.get(i).indexOf("#"
                                                + replyNumber + " ")
                                                + identify1.length());
                                    }
                                }
                        ...
                        int studentSelection3 = JOptionPane.showOptionDialog(null,
                                "Please choose one of the following:", "Learning Management System",
                                JOptionPane.PLAIN_MESSAGE, 1, null, options14, null) + 1;

                        while (studentSelection3 == 0) {
                            invalidInputMessage();
                            studentSelection3 = JOptionPane.showOptionDialog(null,
                                    "Please choose one of the following:", "Learning Management System",
                                    JOptionPane.PLAIN_MESSAGE, 1,
                                    null, options14, null) + 1;
                        ...
                        if (studentSelection3 == 1) {
                                ...
                                if (x == 1) {
                                    ...
                                    do {
                                        ...
                                        try {
                                            ...
                                            JOptionPane.showMessageDialog(null,
                                                    "The filename entered doesn't exist!",
                                                    "Learning Management System",
                                                    JOptionPane.ERROR_MESSAGE);
                                            fileCheck = false;
                                        } catch (IOException ioException) {
                                            JOptionPane.showMessageDialog(null,
                                                    "There was an error in importing the file provided!",
                                                    "Learning Management System",
                                                    JOptionPane.ERROR_MESSAGE);
                                            fileCheck = false;
                                        } catch (Exception exception) {
                                            JOptionPane.showMessageDialog(null,
                                                    "Invalid input! Please enter the filename.",
                                                    "Learning Management System",
                                                    JOptionPane.ERROR_MESSAGE);
                                            fileCheck = false;
                                        }
                                    ...
                                    studentPost = JOptionPane.showInputDialog(null,
                                            "Enter the content for the post below:",
                                            "Learning Management System",
                                            JOptionPane.QUESTION_MESSAGE);
                                }
                                //Checking for valid input
                            ...
                            JOptionPane.showMessageDialog(null,
                                    "Your post has been added!", "Learning Management System",
                                    JOptionPane.INFORMATION_MESSAGE);

                        } else if (studentSelection3 == 2) {
                            if (noResponses) {
                                JOptionPane.showMessageDialog(null,
                                        "No Responses for this discussion forum!",
                                        "Learning Management System", JOptionPane.ERROR_MESSAGE);
    ...
    public static void createCourseGUI() throws Exception {
        ...
        while (courseName == null || courseName.equals("")) {
            JOptionPane.showMessageDialog(null,
                    "Invalid! Please enter a course name", "Learning Management System",
                    JOptionPane.ERROR_MESSAGE);
        ...
        if (sameCourse) {
            JOptionPane.showMessageDialog(null,
                    "Course already exists!", "Learning Management System",
                    JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(null,
                    "Course has been created!", "Learning Management System",
                    JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    public static void createDiscussionGUI() throws Exception {
        ...
        do {
            ...
            int x = JOptionPane.showOptionDialog(null,
                    "Learning Management System", "Please choose one of the following:",
                    JOptionPane.PLAIN_MESSAGE, 1, null, options, null);
            while (x == -1) {
                invalidInputMessage();
                x = JOptionPane.showOptionDialog(null, "Learning Management System",
                        "Please choose one of the following:", JOptionPane.PLAIN_MESSAGE,
                        1, null, options, null);
            }
            String topic = "";
            if (x == 0) {
                String header = JOptionPane.showInputDialog(null,
                        "Enter the topic for Discussion Forum",
                        "Learning Management System", JOptionPane.QUESTION_MESSAGE);

                //Checking for valid input
                while (header == null || header.equals("")) {
                    JOptionPane.showMessageDialog(null,
                            "Invalid input! Please enter topic for discussion Forum",
                            "Learning Management System", JOptionPane.ERROR_MESSAGE);
                    header = JOptionPane.showInputDialog(null,
                            "Enter the topic for Discussion Forum", "Learning Management System",
                            JOptionPane.QUESTION_MESSAGE);
                }

                //System.out.println("Enter the prompt");
                String content = JOptionPane.showInputDialog(null, "Enter the prompt",
                        "Learning Management System", JOptionPane.QUESTION_MESSAGE);

                // Checking for valid input
                while (content == null || content.equals("")) {
                    JOptionPane.showMessageDialog(null,
                            "Invalid input! Please enter prompt for discussion Forum",
                            "Learning Management System", JOptionPane.ERROR_MESSAGE);
                    content = JOptionPane.showInputDialog(null,
                            "Enter the prompt", "Learning Management System",
                            JOptionPane.QUESTION_MESSAGE);
                }
                ...
                do {
                    ...
                    try {
                        ...
                        if (data.isEmpty()) {
                            JOptionPane.showMessageDialog(null,
                                    "The file is empty!", "Learning Management System",
                                    JOptionPane.ERROR_MESSAGE);
                            fileCheck = false;
                        }
                    } catch (FileNotFoundException fileNotFoundException) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "The filename entered doesn't exist!", "Learning Management System",
                                JOptionPane.ERROR_MESSAGE);
                        fileCheck = false;
                    } catch (IOException ioException) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Invalid input! Please enter the filename.", "Learning Management System",
                                JOptionPane.ERROR_MESSAGE);
                        fileCheck = false;
                    }
                } while (!fileCheck);
            ...
            if (checkSameDiscussionForum) {
                JOptionPane.showMessageDialog(null,
                        "The Discussion Forum entered already exists! " +
                                "Please enter different topic and prompt!", "Learning Management System",
                        JOptionPane.ERROR_MESSAGE);
            }
        ...
        JOptionPane.showMessageDialog(null,
                "The Discussion Forum has been created!", "Learning Management System",
                JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public static void gradeStudentGUI() throws Exception {
        ...
        if (studentUsernameArrayList.size() == 0) {
            ...
            String studentUsernameSelected = (String) JOptionPane.showInputDialog(null,
                    "Select the student to grade", "Learning Management System",
                    JOptionPane.PLAIN_MESSAGE, null, options10, null);

            while (studentUsernameSelected == null) {
                invalidInputMessage();
                studentUsernameSelected = (String) JOptionPane.showInputDialog(null,
                        "Select the student to grade", "Learning Management System",
                        JOptionPane.PLAIN_MESSAGE, null, options10, null);
            }
            ...
            if (studentPosts.size() == 0) {
                //Print line if there are no posts made by the Student
                //System.out.println("The Student User selected has not made any posts!");
                JOptionPane.showMessageDialog(null,
                        "The Student User selected has not made any posts!",
                        "Learning Management System", JOptionPane.ERROR_MESSAGE);
            } else {
                StringBuilder sb = new StringBuilder();
                ...
                for (int i = 0; i < studentPosts.size(); i++) {
                    ...
                    do {
                        ...
                        try {
                            grade1 = Double.parseDouble(JOptionPane.showInputDialog(null,
                                    sb.toString() + "Please enter the grade for the Post #" + postNumber1,
                                    "Learning Management System", JOptionPane.PLAIN_MESSAGE));

                            while (grade1 < 0.0 || grade1 > 10.0) {
                                //System.out.println("Please enter a grade value between 0.0 to 10.0");
                                JOptionPane.showMessageDialog(null,
                                        "Please enter a grade value between 0.0 to 10.0",
                                        "Learning Management System", JOptionPane.ERROR_MESSAGE);
                                grade1 = Double.parseDouble(JOptionPane.showInputDialog(null,
                                        sb.toString() + "Please enter the grade for the Post #" + postNumber1,
                                        "Learning Management System", JOptionPane.PLAIN_MESSAGE));
                            ...
                            JOptionPane.showMessageDialog(null,
                                    "Invalid input! Please enter a grade value between 0.0 to 10.0",
                                    "Learning Management System", JOptionPane.ERROR_MESSAGE);
                            notAnInteger17 = true;
                ...
                JOptionPane.showMessageDialog(null,
                        "The Student User selected has been graded!",
                        "Learning Management System", JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void commentOnStudentPostsGUI() throws Exception {
        ...
        while (reply == null || reply.equals("")) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Invalid input! Please enter the reply for the post!",
                    "Learning Management System", JOptionPane.ERROR_MESSAGE);
    ...
    public static void teacherOption2() throws Exception {
        ...
        if (coursesStatus.equals("no courses")) {
            ...
            int teacherSelection2 = JOptionPane.showOptionDialog(null,
                    "Course: " + courseName1, "Learning Management System",
                    JOptionPane.PLAIN_MESSAGE, 1, null, options6, options6[0]) + 1;
            while (teacherSelection2 == 0) {
                invalidInputMessage();
                teacherSelection2 = JOptionPane.showOptionDialog(null,
                        "Course: " + courseName1, "Learning Management System",
                        JOptionPane.PLAIN_MESSAGE, 1, null, options6, options6[0]) + 1;
            }
                ...
                if (noDiscussionForums != true) {
                    ...
                    if (noDisc) {
                        ...
                        if (noResponses) {
                            ...
                            int teacherReplyStudents = JOptionPane.showOptionDialog(null,
                                    "Please choose the action for the Student Post selected:",
                                    "Learning Management System", JOptionPane.PLAIN_MESSAGE,
                                    1, null, options12, null) + 1;
                            while (teacherReplyStudents == 0) {
                                invalidInputMessage();
                                teacherReplyStudents = JOptionPane.showOptionDialog(null,
                                        "Please choose the action for the Student Post selected:",
                                        "Learning Management System", JOptionPane.PLAIN_MESSAGE,
                                        1, null, options12, null) + 1;
                            }
    ...
    public static int teacherMenu1() throws Exception {
        String[] options2 = {"Create a course", "Select a course", "Grade a Student", "Edit or delete account", "Exit"};
        int teacherUserSelection1 = JOptionPane.showOptionDialog(null,
                "Please choose one of the following:", "Learning Management System",
                JOptionPane.PLAIN_MESSAGE, 1, null, options2, null) + 1;
        // System.out.println(teacherUserSelection1);
        while (teacherUserSelection1 == 0) {
            invalidInputMessage();
            teacherUserSelection1 = JOptionPane.showOptionDialog(null,
                    "Please choose one of the following:", "Learning Management System",
                    JOptionPane.PLAIN_MESSAGE, 1, null, options2, null) + 1;
        }
    ...
    public static void invalidInputMessage() {
        JOptionPane.showMessageDialog(null,
                "Please enter the required input/choose the required option" + "\n" +
                        "or use the EXIT button where available.", "Learning Management System",
