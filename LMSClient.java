...
public class LMSClient {
    //TODO:Exception
    //todo: cancel/cross button
    //TODO: FOR EXCEPTIONS WE CAN PRINT STACK TRACE IN TERMINAL RIGHT?
    Person person1;
    private static ObjectOutputStream objectOutputStream;
    private static ObjectInputStream objectInputStream;
    //TODO: CAN WE KEEP THESE STATIC?
                        ...
                        if (studentSelection1 == 1) {
                            ...
                            for (int i = 0; i < posts.size(); i++) {
                                if (posts.get(i).getStudent() != null
                                    ...
                                    //System.out.println();
                                    sb.append("\n");
                                    sb.append("Response: " + posts.get(i).getPost());
                                    sb.append("\n");
                    ...
                    if (noDisc) {
                        ...
                        for (int i = 0; i < posts.size(); i++) {
                            if (posts.get(i).getCourseName().equalsIgnoreCase(courseName1) &&
                                ...
                                stringBuilder1.append(posts.get(i).getDiscussionTopic().getTopic());
                                stringBuilder1.append("\n");
    ...
    public static int teacherMenu1 () throws  Exception {
        ...
        int teacherUserSelection1 =  JOptionPane.showOptionDialog(null, "Please choose one of the following:", "Learning Management System",
                JOptionPane.PLAIN_MESSAGE, 1, null, options2, options2[0]) + 1;
